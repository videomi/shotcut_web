...
|-----------------------|-------------------
| [Windows installer](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win64-210227.exe) | [Windows installer](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-win64-210227.exe)
| [Windows portable zip](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win64-210227.zip) | [Windows portable zip](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-win64-210227.zip)
{:.withborders}
...
| Site 1 (FossHub) &nbsp; &nbsp; | Site 2 (GitHub)
|-----------------------|-----------------------------
| [macOS dmg](https://www.fosshub.com/Shotcut.html?dwl=shotcut-macos-signed-210227.dmg) | [macOS dmg](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-macos-signed-210227.dmg)
{:.withborders}

{:.mac}
An [unsigned app bundle is available on
GitHub](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-macos-unsigned-210227.dmg) so that you
...
| Site 1 (FossHub)      | Site 2 (GitHub)
|-----------------------|-------------------
| [Linux portable tar](https://www.fosshub.com/Shotcut.html?dwl=shotcut-linux-x86_64-210227.txz) | [Linux portable tar](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-linux-x86_64-210227.txz)  
| [Linux AppImage](https://www.fosshub.com/Shotcut.html?dwl=shotcut-linux-x86_64-210227.AppImage) | [Linux AppImage](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-linux-x86_64-210227.AppImage)
{:.withborders}
...
[md5sum](https://github.com/mltframework/shotcut/releases/download/v21.02.27/md5sums.txt)
or [sha256sum](https://github.com/mltframework/shotcut/releases/download/v21.02.27/sha256sums.txt) format.

[Source code
archive](https://github.com/mltframework/shotcut/releases/download/v21.02.27/shotcut-src-210227.txz)
