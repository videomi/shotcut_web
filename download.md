...
|-----------------------|-------------------
| [64-bit Windows installer](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win64-190914.exe) | [64-bit Windows installer](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-win64-190914.exe)
| [64-bit Windows portable zip](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win64-190914.zip) | [64-bit Windows portable zip](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-win64-190914.zip)
| [32-bit Windows installer](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win32-190914.exe) | [32-bit Windows installer](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-win32-190914.exe)
| [32-bit Windows portable zip ](https://www.fosshub.com/Shotcut.html?dwl=shotcut-win32-190914.zip) | [32-bit Windows portable zip](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-win32-190914.zip)
{:.withborders}
...
| Site 1 (FossHub) &nbsp; &nbsp; | Site 2 (GitHub)
|-----------------------|-----------------------------
| [macOS dmg](https://www.fosshub.com/Shotcut.html?dwl=shotcut-macos-signed-190914.dmg) | [macOS dmg](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-macos-signed-190914.dmg)
{:.withborders}

{:.mac}
An [unsigned app bundle is available on
GitHub](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-macos-unsigned-190914.dmg) so that you
...
| Site 1 (FossHub)      | Site 2 (GitHub)
|-----------------------|-------------------
| [64-bit Linux portable tar](https://www.fosshub.com/Shotcut.html?dwl=shotcut-linux-x86_64-190914.txz) | [64-bit Linux portable tar](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-linux-x86_64-190914.txz)  
| [64-bit Linux AppImage](https://www.fosshub.com/Shotcut.html?dwl=Shotcut-190914.glibc2.14-x86_64.AppImage) | [64-bit Linux AppImage](https://github.com/mltframework/shotcut/releases/download/v19.09.14/Shotcut-190914.glibc2.14-x86_64.AppImage)
{:.withborders}
...
[md5sum](https://github.com/mltframework/shotcut/releases/download/v19.09.14/md5sums.txt)
or [sha256sum](https://github.com/mltframework/shotcut/releases/download/v19.09.14/sha256sums.txt) format.

[Source code
archive](https://github.com/mltframework/shotcut/releases/download/v19.09.14/shotcut-src-190914.txz)
